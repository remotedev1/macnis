    ...
    <section className="pb-16 pt-20 bg-white text-gray-800">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto mb-12">
          At Macnis.Com, we transform your home construction dreams into reality
          with our expert team & seamless process. From design to delivery, we
          ensure quality & transparency at every step of the way. Our mission is
          to build homes that embody your vision, constructed with top-notch
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="p-6 bg-gray-50 rounded-xl border-l-4 border-yellow-500 shadow-sm text-left">
            ...
            <p className="text-sm text-gray-600">
              ...
              transparency. The estimate remains unchanged once finalized until
              and unless the client makes the changes.
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-50 rounded-xl border-l-4 border-yellow-500 shadow-sm text-left">
            ...
            <p className="text-sm text-gray-600">
              Home construction with perfection! We perform 440+ quality checks
              to ensure your home meets the highest construction standards.
            </p>
          </div>
